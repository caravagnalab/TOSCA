...
```{r, message=FALSE, warning=FALSE, fig.width=7, fig.height=7, dpi = 100}
TOSCA::plot_mcmc_chains(UPN06)
```

```{r, message=FALSE, warning=FALSE, fig.width=3, fig.height=3, dpi = 100}
...
```{r, message=FALSE, warning=FALSE, fig.width=7, fig.height=3, dpi = 100}
